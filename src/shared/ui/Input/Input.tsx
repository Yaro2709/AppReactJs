...
type HTMLInputProps = Omit<InputHTMLAttributes<HTMLInputElement>, 'value' | 'onChange'> // расширяем стандартные пропсы, который может принимать input, а также позволяет устранить конфликт типов.
